...
import ModalProducto from "../../../Productos/ModalProducto"; // 👈 Asegúrate de importar correctamente
import { agregarAlCarrito } from "./Lupa/agregarAlCarrito";
    ...
    const fetchProductos = async () => {
      ...
      try {
        const res = await fetch(
          `http://localhost:5000/api/productos_buscar/buscar?nombre=${busqueda}`
        );
        if (res.ok) {
